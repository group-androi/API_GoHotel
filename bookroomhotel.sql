...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 05, 2019 at 04:56 AM
...
CREATE TABLE IF NOT EXISTS `device` (
  `id_device` char(32) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `device_id` char(16) COLLATE utf8_unicode_ci DEFAULT NULL,
...
('06-05-1996', '0947016', NULL, 'e35cf7b66449df565f93c607d5a81d09', NULL, NULL);
